...
/**
 * Servlet implementation class gereCmpServ
 */
@WebServlet("/gereCmpServ")
public class ajouterCmtServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ajouterCmtServ() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher DL =request.getRequestDispatcher("/AjouterCompte.html");
