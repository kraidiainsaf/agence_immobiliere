...
<%@ include file="header.jsp" %>
 <div class="main-grid">
 <form action="creeLocS1" method="post">
			
								<%if((request.getAttribute("erroPseudo").equals("error")) ){%>
<div id="er">
<h3 > <img src="pic\error12.png" width="20px" height="20px" align="top"> ce pseudo et password existent déja! <img src="pic/sorry.png" width="25px" height="25px" align="top"> Réessayer encore  </h3><%} %>
</div></br>
...
<label 	label class="col-md-2 control-label"><img alt="" src="pic\pass.png" width="20px" height="20px" align="top" ><b> Password: </b></label>
<div class="input-group input-icon right">
													<span class="input-group-addon">
														<i class=""></i>
													</span>
