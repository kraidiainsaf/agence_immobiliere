...
<% 
 ...
 <%}} }%> 
<title>Recherche Depot</title></head>
...
<label><img width="30px" height="30px" src="box.png"> Capacité De Stockage :</label>
...
<label class="radio-inline">1000-1500 box <input type="radio" name="capacite_stockage" value="1500"></label>
<label class="radio-inline">pas<input type="radio" name="capacite_stockage" value="-1"></label>

<br><br>
<label><img width="20px" height="20px" src="depot.png"> Type Depot :</label>
<label class="radio-inline"><img width="15px" height="15px" src="sun.png"> Depot a ciel ouvert(non couvet) <input type="radio" name="type" value="depot a ciel ouvert" ></label>
<label class="radio-inline"><img width="15px" height="15px" src="frigo.png"> Frigorifique <input type="radio" name="type" value="frigorifique"></label>
<label class="radio-inline"><img width="15px" height="15px" src="nsun.png"> Depot couvet <input type="radio" name="type" value="depot couvet" ></label>
<br><br>
