...
<script type="text/javascript">
     ...
     function v() {
					...
					if((document.form.etage.value=="")||(document.form.etage.value==null)){
						alert("vous devez remplir tous les champs!");
						return false;
					}
...
<title>Recherche Appartement</title></head>
<%
...
<input type="hidden" name="typebien" value="appartement">	
	   <img width="30px" height="30px" src="chambre.png">  <label> Nombre Du Chambre :</label>
		   <label class="radio-inline">F1 <input type="radio" name="nbr_chambre" value="1"></label>
	       <label class="radio-inline">F2 <input type="radio"name="nbr_chambre" value="2"></label>
		   <label class="radio-inline">F3 <input type="radio" name="nbr_chambre" value="3"></label>
		   <label class="radio-inline">F4 <input type="radio"name="nbr_chambre" value="4"></label> 
		   <label class="radio-inline">F5 <input type="radio" name="nbr_chambre" value="5"></label>
		   <label class="radio-inline">Pas <input type="radio" name="nbr_chambre" value="-1"></label><br> 
                                     <br>
     <label><img width="30px" height="30px" src="app.png"> Etage  :</label>
<label class="radio-inline"> Etage 1 <input type="radio" name="etage" value="1" ></label>
<label class="radio-inline"> Etage 2 <input type="radio" name="etage" value="2"></label>
<label class="radio-inline"> Etage 3 <input type="radio" name="etage" value="3"></label>
<label class="radio-inline"> Etage 4 <input type="radio" name="etage" value="4"></label>
<label class="radio-inline"> Etage 5 <input type="radio" name="etage" value="5"></label>
<label class="radio-inline"> Etage 6 <input type="radio" name="etage" value="6" ></label>
<label class="radio-inline"> Etage 7 <input type="radio" name="etage" value="7"></label>
<label class="radio-inline"> Etage 8 <input type="radio" name="etage" value="8"></label>
<label class="radio-inline"> Etage 9 <input type="radio" name="etage" value="9"></label>
<label class="radio-inline"> Etage 10 <input type="radio" name="etage" value="10"></label>
<label class="radio-inline">Pas  <input type="radio" name="etage" value="-1"></label><br>
<br>
