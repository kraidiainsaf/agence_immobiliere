...
<%depot m=(depot) session.getAttribute("depot");%>
...
<div class="home-lager-shearch" style="padding-top: 25px; margin-top: -10px; padding-bottom: 60px; background-color: rgb(252, 252, 252);"  style="text-align:center;">
    ...
    <h2  style="text-align: center;color:#F4C543;"><i ><u> Modifier Depot </u></i>:</h2><br>
...
<%String n=m.getType();char k='"';String a1="",a2="",a3="";
if(n.equals("depot a ciel ouvert")){
    a1="checked="+k+"checked"+k;
}
if(n.equals("frigorifique")){
	 a2="checked="+k+"checked"+k;
}
if(n.equals("depot couvet")){
	 a3="checked="+k+"checked"+k;
}
%>
<label class="radio-inline"> depot a ciel ouvert(non couvet) <input type="radio" name="type"  <%=a1 %> value="depot a ciel ouvert" ></label>
<label class="radio-inline"> frigorifique <input type="radio" <%=a2 %> name="type" value="frigorifique"></label>
<label class="radio-inline"> depot couvet <input type="radio"  <%=a3 %> name="type" value="depot couvet" ></label><br><br>
<label><img width="30px" height="30px" src="box.png">Capacite de stockage :</label>
<input type="number" name="superficie" style="width:200px;" value=<%=m.getCapacite_stockage() %> disabled="disabled" ><br><br>
