...
<h1  style="text-align: center;color:#F4C543;"><i><img width="80px" height="80px"  src="titre.png"> <u> Ajouter Un Terrain </u></i></h1>
...
<br><input type="hidden" name="typebien" value="terrain">
