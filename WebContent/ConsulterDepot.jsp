...
<%HttpSession depots=request.getSession();
ArrayList<bien> list=(ArrayList<bien>)depots.getAttribute("list");cntrlCompte c=new cntrlCompte();
cntrlBien b=new cntrlBien();
if(list.isEmpty()){ 
	%>
	 <h1 align="center">aucun depot disponible</h1>
	<%
}
else{
%>
<h1 align="center"><img height="50" width="50" src="pic\depott.png"> Liste des depots </h1>
</br>
...
<th  align="center"><img height="20" width="20" src="pic\type.png">type</th>
<th  align="center"><img height="20" width="20" src="pic\capacite.png">capacité de stockage</th>
...
<td align="center"><%=b.gettypedepot(bi.getId_bien()) %> 
<td align="center"><%=b.getCapacite(bi.getId_bien()) %> 
