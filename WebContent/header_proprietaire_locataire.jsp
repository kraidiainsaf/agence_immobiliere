...
.show {display:block;}
        ...
        <title>El KERIA | Espace Proprietaire|locataire</title>
  ...
  <div id="myDropdown" class="dropdown-content">
   ...
   <a href="ConsulterNotificationServlet"><img width="20px" height="20px"   src="notif.png"> Notifications</a>
                    ...
                    <ul class="main-nav nav navbar-nav navbar-right">
                      <li class="wow fadeInDown" data-wow-delay="0.1s"><a class="" href="EspaceLocatair_proprietaire.jsp">Accueil</a></li>
                        <li class="wow fadeInDown" data-wow-delay="0.1s"><a class="" href="GoRechercherBien">Rechercher  bien</a></li>
                        <li class="wow fadeInDown" data-wow-delay="0.1s"><a class="" href="GoAjouterBien">Ajouter bien</a></li>
                        <li class="wow fadeInDown" data-wow-delay="0.4s"><a href="MesBienServlet">Mes Biens</a></li>
