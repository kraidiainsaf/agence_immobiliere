...
<% m=(depot)session.getAttribute("depot");%>
...
<div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
  ...
  <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        ...
                                        <span class="property-info-value"><%=m.getSuperficie()%><b class="property-info-unit">M²</b></span>
                                    </span>
                                </div>
                                 <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    <span class="property-info-icon icon-bed">
                                        <img width="30px" height="30px"  src="box.png">
                                    </span>
                                    <span class="property-info-entry">
                                        <span class="property-info-label"> Capacité de Stockage</span>
                                        <span class="property-info-value"><%=m.getCapacite_stockage()%></span>
                                    </span>
                                </div>

                                <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    <span class="property-info-icon icon-bath">
                                        <img  width="30px" height="30px"  src="depot.png">
                                    </span>
                                    <span class="property-info-entry">
                                        <span class="property-info-label"> Type </span>
                                        <span class="property-info-value"><%=m.getType()%></span>
                                    </span>
                                </div>
                               ...
                               <div class="section">
                                ...
                                <%listl=(ArrayList<location>)session.getAttribute("listl");int co=1;%>
                                   <%if(listl.isEmpty()){ %>
 <h6 style="text-align: center;" ><img width="40px" height="40px" src="vide.png"> pas des locations Approuver a ce bien </h6>
 <%}else{ %>
   <table >
                                   <thead>	
    <tr>
                        ...
                        <aside class="sidebar sidebar-property blog-asside-right" style="align-content: right ">
                            ...
                            <div class="panel panel-default sidebar-menu similar-property-wdg wow fadeInRight animated">
                                ...
                                <div class="panel-body recent-property-widget">
                                        ...
                                        <% ArrayList<depot> l=op.Newsdepot(); 
