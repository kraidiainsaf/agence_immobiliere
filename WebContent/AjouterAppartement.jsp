...
<h1  style="text-align: center;color:#F4C543;"><i><img width="80px" height="80px"  src="titre.png"> <u> Ajouter Une Appartement</u></i></h1>
...
<label class="radio-inline"> 1 <input type="radio" name="etage" value="1" ></label>
<label class="radio-inline"> 2 <input type="radio" name="etage" value="2"></label>
<label class="radio-inline"> 3  <input type="radio" name="etage" value="3"></label>
<label class="radio-inline"> 4  <input type="radio" name="etage" value="4"></label>
<label class="radio-inline"> 5 <input type="radio" name="etage" value="5"></label>
<label class="radio-inline"> 6  <input type="radio" name="etage" value="6"></label>
<label class="radio-inline"> 7 <input type="radio" name="etage" value="7"></label>
<label class="radio-inline"> 8 <input type="radio" name="etage" value="6"></label>
<label class="radio-inline"> 9  <input type="radio" name="etage" value="7"></label>
<label class="radio-inline"> 10 <input type="radio" name="etage" value="8"></label><br>
