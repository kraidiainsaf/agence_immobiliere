...
<% personne pr=new personne(); %>
		        function v() {
		        var res=	pr.ispers(document.form.pesr.value);
					if(res){
...
<form name="form"  action="supprimerCmpt" method="get" >
...
<%utilisateur1.setAttribute("type","loc"); %>
<% cntrlNotif nt=new cntrlNotif(); %>
<% personne p1=new personne();
ArrayList<String> list=p1.getNamesSupp();
