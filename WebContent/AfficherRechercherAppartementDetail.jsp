...
<% m=(appartement)session.getAttribute("appartement");%>
...
<div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
  ...
  <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                 ...
                                 <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        <span class="property-info-label"> Etage</span>
                                        <span class="property-info-value"><%=m.getEtage()%></span>
                                    </span>
                                </div>
                        ...
                        <aside class="sidebar sidebar-property blog-asside-right" style="align-content: right ">
                            <div class="dealer-widget">
                                ...
                                <div class="panel-body recent-property-widget">
                                        ...
                                        <% ArrayList<appartement> l=op.NewsApp(); 
                                        for(int t=0;t<l.size();t++){ 
                                        appartement tt=l.get(t);
                                        %>
