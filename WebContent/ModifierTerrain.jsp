...
<%terrain m=(terrain) session.getAttribute("terrain");%>
...
<div class="home-lager-shearch" style="padding-top: 25px; margin-top: -10px; padding-bottom: 60px; background-color: rgb(252, 252, 252);"  style="text-align:center;">
    ...
    <h2  style="text-align: center;color:#F4C543;"><i ><u> Modifier Terrain </u></i>:</h2><br>
...
<br>
<%String n=m.getCaracteristique();char k='"';String a1="",a2="";
if(n.equals("industriel")){
    a1="checked="+k+"checked"+k;
}
if(n.equals("Agricole")){
	 a2="checked="+k+"checked"+k;
}

%>
<label> caracteristique  :</label>
<label class="radio-inline"> Industriel <input type="radio" <%=a1 %> name="caracteristique" value="industriel" ></label>
<label class="radio-inline">Agricole <input type="radio" <%=a2 %> name="caracteristique" value="Agricole"></label><br><br>
