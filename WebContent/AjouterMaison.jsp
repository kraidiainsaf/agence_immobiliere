...
<h1  style="text-align: center;color:#F4C543;"><i><img width="80px" height="80px"  src="titre.png"> <u> Ajouter Une Maison </u></i></h1>
...
<input type="number" name="prix" placeholder="100.00 DA" max="100000000000.00" min="50.000" style="width:200px;"><br><br>
...
<label class="radio-inline"> F5 <input  type="radio" name="nbr_chambre" value="5"></label><br>
<br>
<label><img width="30px" height="30px" src="facade.png"> Nombre Du Facade :</label>
<label class="radio-inline"> 1 <input type="radio" name="nbr_facade" value="1" ></label>
<label class="radio-inline"> 2 <input type="radio" name="nbr_facade" value="2"></label>
<label class="radio-inline"> 3  <input type="radio" name="nbr_facade" value="3"></label>
<label class="radio-inline"> 4  <input type="radio" name="nbr_facade" value="4"></label><br><br>

<label><img width="30px" height="30px" src="jardin.png"> Avec Jardin :</label>
<label class="radio-inline"> Oui <input type="radio" name="jardin" value="true" ></label>
<label class="radio-inline"> Non<input type="radio" name="jardin" value="false"></label><br><br>

<label><img width="30px" height="30px" src="parking.png"> Avec Parking :</label>
<label class="radio-inline"> Oui <input type="radio" name="parking" value="true" ></label>
<label class="radio-inline"> Non <input type="radio" name="parking" value="false"></label><br><br>
<input type="hidden" name="typebien" value="maison">
<input style="width: 200px;background-color: #e8e3e3;border: 1px solid #F4C543;" type="submit" name="établir votre  contrat" value="établir votre  contrat">
</form>    </div>
            </div>
        </div></div>
