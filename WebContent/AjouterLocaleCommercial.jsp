...
<% 
 ...
 <script type="text/javascript">
		        function v() {
					...
					if((document.form.distance_centre.value=="")||(document.form.distance_centre.value==null)){
						alert("vous devez remplir tous les champs!");
						return false;
					}
...
<h1  style="text-align: center;color:#F4C543;"><i><img width="80px" height="80px"  src="titre.png"> <u> Ajouter Un Locale Commercial </u></i></h1>
...
<label><img width="20px" height="20px" src="seperficie2.png">Distance au Centre (en mètre)</label>
<input type="number" name="distance_centre" placeholder="10 metre a partire au centre" min="1" max="1000" style="width:200px;"><br><br>
<label><img width="20px" height="20px" src="local.png"> Type Locale :</label>
<label class="radio-inline"> Boutique <input type="radio" name="type_local" value="boutique"></label>
<label class="radio-inline"> Cabinet (medicale,conptabilité,les travaux lidirale) <input type="radio" name="type_local" value="cabinet" ></label>
<label class="radio-inline"> Magasin(ou superet)<input type="radio" name="type_local" value="magasin(ou superet)"></label>
<label class="radio-inline" > Marché<input type="radio" name="type_local" value="marché"></label><br>
<br>
