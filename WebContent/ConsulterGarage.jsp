...
<%HttpSession  garage=request.getSession();
ArrayList<bien> list=(ArrayList<bien>)garage.getAttribute("list"); cntrlCompte c=new cntrlCompte();
cntrlBien b=new cntrlBien();
if(list.isEmpty()){ 
	%>
	 <h1 align="center">aucun garage disponible</h1>
	 <% 
}
else{
%>
<h1 align="center"><img height="50" width="50" src="pic\garagee.png">  liste des garages </h1></br>
</div>
...
<th  align="center"><img height="20" width="20" src="pic\capacityv.png"> capacité de stockage</th>
...
<td align="center"><%=b.getCapacitéVéhi(bi.getId_bien()) %> 
