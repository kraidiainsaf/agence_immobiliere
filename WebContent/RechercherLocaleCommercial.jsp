...
<script type="text/javascript">
     ...
     function v() {
					...
					if((document.form.dmax.value=="")||(document.form.dmax.value==null)){
						alert("vous devez remplir tous les champs!");
						return false;
					}
					if((document.form.dmin.value=="")||(document.form.dmin.value==null)){
						alert("vous devez remplir tous les champs!");
						return false;
					}
...
<% 
 ...
 <%}} }%> 
<title>Recherche locale</title></head>
...
<label><img width="30px" height="30px" src="local.png"> Type locale :</label><br>
<label class="radio-inline"><img width="20px" height="20px" src="boutic.png"> Boutique  :<input type="radio" name="type_local" value="boutique"></label><br>
<label class="radio-inline"><img width="20px" height="20px" src="doct.png"> Cabinet (medicale,conptabilité,les travaux lidirale) :<input type="radio" name="type_local" value="cabinet" ></label><br>
<label class="radio-inline"><img width="20px" height="20px" src="locale2.png"> Magasin(ou superet) : <input type="radio" name="type_local" value="magasin(ou superet)"></label><br>
<label class="radio-inline"><img width="20px" height="20px" src="tomat.png"> Marché  :<input type="radio" name="type_local" value="marché"></label>
<br><br>
<label><img width="20px" height="20px" src="seperficie2.png"> Distance maximale apartir  centre  :</label>
<input type="number" name="dmax" placeholder="10m" style="width:200px;"><br><br>
<label><img width="30px" height="30px" src="superficie.png"> Distance minimale apartir  centre :</label>
<input type="number" name="dmin" placeholder="5m" style="width:200px;" ><br><br>
