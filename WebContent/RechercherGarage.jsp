...
<script type="text/javascript">
     ...
     function v() {
					...
					if((document.form.capacite_vehicule.value=="")||(document.form.capacite_vehicule.value==null)){
						alert("vous devez remplir tous les champs!");
						return false;
					}
...
<% 
 ...
 <%}} }%> 
<title>Recherche Garage</title></head>
...
<label><img width="30px" height="30px" src="car.png"> Capacite De Vehicule :</label>
<label class="radio-inline"> Une voiture <input type="radio" name="capacite_vehicule" value="1" ></label>
<label class="radio-inline"> Deux voitures <input type="radio" name="capacite_vehicule" value="2"></label>
<label class="radio-inline"> Trois voitures <input type="radio" name="capacite_vehicule" value="3"></label>
<label class="radio-inline"> Quatre voitures <input type="radio" name="capacite_vehicule" value="3"></label>
<label class="radio-inline">Parking(5-15) <input type="radio" name="capacite_vehicule" value="15"></label>
<br>
