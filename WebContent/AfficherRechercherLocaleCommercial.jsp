...
<%ArrayList<locale_commercial> list=null;%>
<%list=(ArrayList<locale_commercial>)session.getAttribute("list");int i=0;%>
 <%if(list==null){
...
<br><br>
 ...
 <div class="col-md-12 clear " style="display:inline;text-align: center;"> 
                        ...
                        <%while(list.isEmpty()==false){
                        	locale_commercial m=list.get(i);
%>
                                ...
                                <div class="box-two proerty-item" >
                                    ...
                                    <div class="item-entry overflow">
                                        ...
                                        <div class="property-icon">
                                            <img width="30px" height="30px" src="dis.png">(<%=m.getDistance_center() %>)|
