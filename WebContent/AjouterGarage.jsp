...
<h1  style="text-align: center;color:#F4C543;"><i><img width="80px" height="80px"  src="titre.png"> <u> Ajouter Un Garage </u></i></h1>
...
<label class="radio-inline">1 <input type="radio" name="capacite_vehicule" value="1" ></label>
<label class="radio-inline">2 <input type="radio" name="capacite_vehicule" value="2"></label>
<label class="radio-inline">3 <input type="radio" name="capacite_vehicule" value="3"></label>
<label class="radio-inline">4 <input type="radio" name="capacite_vehicule" value="3"></label>
