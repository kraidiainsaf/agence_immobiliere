...
<%list=(ArrayList<depot>)session.getAttribute("list");int i=0;%>
 <%if(list==null){
                                ...
                                <div class="box-two proerty-item" >
                                    ...
                                    <div class="item-entry overflow">
                                        ...
                                        <div class="property-icon">
                                            <img width="30px" height="30px" src="box.png">(<%=m.getCapacite_stockage() %>)|
                                            <img width="30px" height="30px" src="frigo.png">(<%=m.getType() %>)
