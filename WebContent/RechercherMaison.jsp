...
<% 
 ...
 <%}} }%> 
<title>Recherche Maison</title></head>
...
<P style="border:1px double #f65e5e;background-color:geray;padding:10px;margin-left:400px;margin-right:400px;background-color:#ff8c8c;"><img  width="20px" height="20px;" src="error.png" style="margin:5px;"><%=e %></P>
                        <%} %><br><br>
		<br> <input type="hidden" name="typebien" value="maison">
		 <img width="30px" height="30px" src="chambre.png">  <label> Nombre Du Chambre :</label>
		   ...
		   <label class="radio-inline">Pas <input type="radio" name="nbr_chambre" value="-1"></label><br> 
                                     <br>
		 <img width="30px" height="30px" src="facade.png"><label>Nombre Du Facade :</label>
		  ...
		  <label class="radio-inline"> 3 <input type="radio" name="nbr_facade" value="3"></label>
			 <label class="radio-inline"> 4 <input type="radio" name="nbr_facade" value="4"></label>
			 <label class="radio-inline"> Pas <input type="radio" name="nbr_facade" value="-1"></label>
	<br><br>
