...
<% m=(locale_commercial)session.getAttribute("locale_commercial");%>
...
<div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
  ...
  <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                 ...
                                 <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        <span class="property-info-label"> Distance Centre</span>
                                        <span class="property-info-value"><%=m.getDistance_center()%></span>
                                    </span>
                                </div>

                                <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    <span class="property-info-icon icon-bath">
                                        <img  width="30px" height="30px"  src="doct.png">
                                    </span>
                                    <span class="property-info-entry">
                                        <span class="property-info-label"> Type </span>
                                        <span class="property-info-value"><%=m.getType_local()%></span>
                                    </span>
                                </div>
                            ...
                            <div class="dealer-widget">
                              ...
                              <div class="panel panel-default sidebar-menu similar-property-wdg wow fadeInRight animated">
                                ...
                                <div class="panel-body recent-property-widget">
                                        ...
                                        <% ArrayList<locale_commercial> l=op.Newslocale(); 
                                        for(int t=0;t<l.size();t++){ 
                                        	locale_commercial tt=l.get(t);
                                        %>
