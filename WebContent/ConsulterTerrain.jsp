...
<%HttpSession  terrain=request.getSession();cntrlCompte c=new cntrlCompte();
ArrayList<bien> list=(ArrayList<bien>)terrain.getAttribute("list");
cntrlBien b=new cntrlBien();
if(list.isEmpty()){%>
	 <h1 align="center">aucun terrain disponible</h1>
	 <% 
}
else{
%>
<h1 align="center"><img height="50" width="50" src="pic\terrainn.png"> liste des terrains </h1></br>
...
<th  align="center"><img height="20" width="20" src="pic\description.png">caractéristiques</th>
...
<td align="center"><%=b.getCaractéristique(bi.getId_bien()) %> 
